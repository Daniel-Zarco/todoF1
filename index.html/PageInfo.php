...
<body>
    ...
    <a href="../index.html/PagePrincipal.html" class="back-button">← Volver</a>
...
<script>
    ...
    new Chart(ctxGen, {
        ...
        options: {
            responsive: true,
            plugins: {
                legend: { position: 'bottom', labels: { color: '#ff3b3b', font: { weight: 'bold' } } }
            }
        }
    });
    ...
    new Chart(ctxPais, {
        ...
        options: {
            responsive: true,
            scales: {
                y: { beginAtZero: true, precision: 0, ticks: { color: '#ff3b3b', font: { weight: 'bold' } } },
                x: { ticks: { color: '#ff3b3b', font: { weight: 'bold' } } }
            },
            plugins: {
